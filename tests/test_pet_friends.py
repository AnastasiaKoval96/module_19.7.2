...
def test_add_new_pet_valid_data(name="Джери", animal_type="мышка", age="1", pet_photo="images/maus.jpg"):
...
def test_delete_pet():
    ...
    if len(my_pets["pets"]) == 0:
        pf.add_new_pet(auth_key, "Лорд", "корги", "2", "images/korgi.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_add_new_pet_without_photo_valid_data(name="Рона", animal_type="колли", age="2"):
...
def test_set_photo_pet(pet_photo="images/rona.jpg"):
...
def test_add_new_pet_incorrect_age(name="Джери", animal_type="мышка", age="-1", pet_photo="images/maus.jpg"):
...
def test_set_photo_not_your_pet(pet_photo="images/rona.jpg"):
